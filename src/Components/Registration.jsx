            ...
            >
              {({ errors, touched, handleChange, handleBlur }) => (
                <Form>
                  ...
                  <Button type="submit" fullWidth variant="contained" sx={{fontFamily:"serif", fontWeight:"bold"}}>
                   Register
                  </Button>
                </Form>
              )}
            ...
            <Box textAlign="center" mt={2}>
              <Typography variant="h6" sx={{fontFamily:"serif", fontWeight:"bold"}}>
                ...
                <span
                  ...
                  style={{ fontFamily:"serif", fontWeight : "bold" ,color: "blue", cursor: "pointer", marginLeft: "5px" }}
                >
                  Sign In
                </span>
              </Typography>
